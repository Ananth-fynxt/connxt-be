package connxt.user.service.impl;
...
import connxt.user.repository.UserRepository;
import connxt.user.service.UserService;
import connxt.user.service.mappers.UserMapper;
import connxt.user.util.PasswordUtil;
...
public class UserServiceImpl implements UserService {
  ...
  private void sendUserCreationEmail(String userEmail, String password) {
    try {
      ...
      templateData.put("supportEmail", "support@connxt.fynxt.io");
      templateData.put("companyName", "Connxt Platform");
